...
import { ArrowRightIcon, CalendarIcon, ClockIcon, HistoryIcon, Loader2Icon, TimerIcon, WandIcon, XIcon } from "lucide-react"
    ...
    <div className="max-w-4xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
      ...
      <div className="space-y-6 text-center mt-20">
        ...
        <div className="relative group mt-12">
          ...
          placeholder="Share your tea.. (e.g. A post about the lunch of your new eco-friendly coffee beans)" value={prompt} onChange={(e)=> setPrompt(e.target.value)}/>
          <div className="absolute bottom-4 right-2.5 flex items-center gap-3 text-sm">
            ...
            <button onClick={handleGenerate} disabled={loading} className="bg-slate-900 hover:bg-slate-800 text-white flex items-center gap-2 px-4 py-2 rounded-lg">
              {loading ? (
                <>
                  <Loader2Icon className="sixe-4 animate-spin"/>
                    ...
                    <div className="flex flex-col h-full space-y-4">
                      ...
                      <div className="flex items-center gap-2 pt-2">
                        ...
                        onClick={()=> setActiveScheduler(gen)}
                         className="flex-1 bg-slate-100 hover:bg-red-500 hover:text-white text-slate-600 text-xs py-2.5 rounded-lg">
                          Schedule Post
                        </button>
                      </div>
                    </div>
