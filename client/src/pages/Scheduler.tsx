    ...
    <div className="w-full lg:w-[460px] shrink-0">
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
            ...
            <form onSubmit={handleSchedule} className="space-y-5">
                {/* Platforms */}
                <div>
                    <label className="block text-xs text-slate-500 uppercase mb-2">Platfoems</label>
                ...
                <div>
                    ...
                    {mediaFile ? (
                        <div className="relative rounded-xl overflow-hidden border border-slate-200 bg-slate-50">
                            ...
                            ?
                            <img src={URL.createObjectURL(mediaFile)} alt="review" className="w-full h-40 object-cover"/> 
                            : 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <div className="relative">
                            <CalendarIcon className="size-4 absolute left-3 top-1/2 -translate-y-0.5 text-slate-400 pointer-events-none"/>
                    ...
                    <div>
                        <label className="block text-xs text-slate-500 uppercase mb-2">Date</label>
                        <div className="relative">
                            <ClockIcon className="size-4 absolute left-3 top-1/2 -translate-y-0.5 text-slate-400 pointer-events-none"/>
        ...
        <div className="flex-1 flex flex-col gap-6 min-w-0">
            ...
            <div className="bg-white border rounded-2xl border-slate-200 overflow-hidden">
                <div className="flex items-center gap-2.5 px-5 py-1 border-b border-slate-100">
